...
if ($_GET['sort'] == 'date'){
    $query .= "SELECT * FROM reviews ORDER BY review_date";
} else if ($_GET['sort'] == 'reviewer'){
    $query .= "SELECT * FROM reviews ORDER BY reviewer_name";
} else if ($_GET['sort'] == 'comment'){
    $query .= "SELECT * FROM reviews ORDER BY review_comment";
} else if ($_GET['sort'] == 'rating'){
    $query .= "SELECT * FROM reviews ORDER BY review_rating";
}
...
echo <<< ENDHTML
   ...
   <table cellpadding="2" cellspacing="2"
    ...
    <tr>
     <th style="width: 7em;"><a href="N3P308details.php>Date</th>
     <th style="width: 10em;"><a href="N3P308details.php">Reviewer</th>
     <th><a href="N3P308details.php">Comments</th>
     <th style="width: 5em;"><a href="N3P308details.php">Rating</th>
    </tr>
ENDHTML;
